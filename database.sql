-- ================================================================
-- QUANLY_ESPORTS — DATABASE INITIALIZATION SCRIPT (Safe Re-run)
-- Version : 3.2 (Idempotent)
-- Engine  : SQL Server 2019+
-- Encoding: UTF-8 / NVARCHAR throughout
-- ================================================================
-- HOW TO USE:
--   1. This script can be run multiple times safely
--   2. It will create the database if it doesn't exist
--   3. It will create/modify tables as needed
...
IF NOT EXISTS (SELECT 1 FROM sys.databases WHERE name = N'QuanLy_Esports')
BEGIN
...
BEGIN
    CREATE TABLE XIN_GIA_NHAP (
        ...
        CONSTRAINT UQ_XINGIANHAP UNIQUE (ma_nguoi_dung, ma_nhom),
